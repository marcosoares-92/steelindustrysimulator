...
def update_with_inputs(var1, var2, var3, var4, var5, var6, var7, var8):
  ...
  if ((GlobalVars.start_date != start_date) | (GlobalVars.total_days != total_days) | 
      (GlobalVars.total_days != total_hours) | (GlobalVars.lagging_current_reactive_power != var4) | 
      (GlobalVars.leading_current_reactive_power != var5) | (GlobalVars.co2_tco2 != var6) | 
      (GlobalVars.lagging_current_power_factor != var7) | (GlobalVars.load_type != var8)):
